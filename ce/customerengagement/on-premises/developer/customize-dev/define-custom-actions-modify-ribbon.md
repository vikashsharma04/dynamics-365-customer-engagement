...
> - Since the `HideCustomAction` removes ribbon elements from the ribbon, it will not work for OOB buttons. If you wan to hide an out of the box button, please use a displayrule or hideaction.
